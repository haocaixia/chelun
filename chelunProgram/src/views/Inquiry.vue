            ...
            <div class="main">
                ...
                <div class="person">
                    ...
                    <ul>
                        <li>
                            <span>姓名</span>
                            <input type="text" placeholder="请输入您的真实姓名" value="name" v-model="name" @inputname="input(name)">
                        </li>
                        <li>
                            <span>手机</span>
                            <input type="text" placeholder="请输入您的真实手机号" value="number" v-model="number" @inputnum="input(number)">
                        </li>
                        <li>
                            <span>城市</span>
        ...
        methods: {
            ...
            alert() {
                ...
                if (this.name && this.number) {
                    this.$alert('询价成功', '稍后有顾问会打电话通知,请保持手机畅通');
                }
            },
            inputname(name) {
                this.name = name
